...
export const AnimatableList: Component<Props> = (props: Props) => {
    ...
    const scheduleTransition = debounce((lastSeenElements: HTMLElement[], lastSeenOrder: ElementsOrder, currentElements: HTMLElement[], currentOrder: ElementsOrder) => {
    ...
    createEffect(() => {
        ...
        if (currentIds.length > lastSeenIds.length) {
            ...
            scheduleTransition(lastSeenElements, lastSeenOrder, currentElements, currentOrder);
        }
    });
